...
def parse_user_input(user_input):
    ...
    # Normalize keywords for flexible matching
    normalized_user_input = ' '.join(normalize_keyword(word) for word in user_input_lower.split())

    # Check for specialization keywords
    for keyword in specialization_keywords:
        if normalize_keyword(keyword) in normalized_user_input:
